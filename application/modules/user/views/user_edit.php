...
<!-- Page container -->
 ...
 <input type="hidden" name="instance" value="<?php echo $instance;?>" class="form-control">
 <input type="hidden" name="status_process" value="<?php echo $status_process;?>" class="form-control">
...
<tr>
    ...
    <td>:</td>
    <td style="padding:2px;">
	<select name="lit_level_user" class="form-control" id="level_user" onchange="showleveluser();" required>
 ...
 <!-- Page tabs -->
            ...
            <table id=adk class="table table-striped table-bordered table-hover">
                          ...
                          <TR>
                            <TD>6.5. Nilai KPI</TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad65 value=1 size=20 <?php if($ad65 == '1'){ echo "checked=checked"; }?>></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad65 value=0 size=20 <?php if($ad65 == '0'){ echo "checked=checked"; }?>></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad65 value=2 size=20 <?php if($ad65 == '2'){ echo "checked=checked"; }?>></TD>
                          </TR>
                          <TR>
                            <TD>6.6. Nilai KPI</TD>
            ...
            <table id=adk class="table table-striped table-bordered table-hover">
                          ...
                          <TR >
                            ...
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad81 value=1 <?php if($ad81 == '1'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad81 value=0 <?php if($ad81 == '0'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad81 value=2 <?php if($ad81 == '2'){ echo "checked=checked"; }?> size=20></TD>
                          </TR>
                          <TR >
                            <TD>8.2. Permohonan Cuti</TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad82 value=1 <?php if($ad82 == '1'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad82 value=0 <?php if($ad82 == '0'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad82 value=2 <?php if($ad82 == '2'){ echo "checked=checked"; }?> size=20></TD>
                          </TR>
                          <TR>
                            <TD>8.3. Persetujuan Surat Cuti </TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad83 value=1 <?php if($ad83 == '1'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad83 value=0 <?php if($ad83 == '0'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad83 value=2 <?php if($ad83 == '2'){ echo "checked=checked"; }?> size=20></TD>
                          </TR>
              
                          <TR>
                            <TD>8.4. Monitoring Tanggal Jatuh Tempo Cuti </TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad84 value=1 <?php if($ad84 == '1'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad84 value=0 <?php if($ad84 == '0'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad84 value=2 <?php if($ad84 == '2'){ echo "checked=checked"; }?> size=20></TD>
                          </TR>
                          <TR>
                            <TD>8.5. Laporan Realisasi Cuti</TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad85 value=1 <?php if($ad85 == '1'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad85 value=0 <?php if($ad85 == '0'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad85 value=2 <?php if($ad85 == '2'){ echo "checked=checked"; }?> size=20></TD>
                          </TR>
                          <TR>
                            <TD>8.6. Laporan Rekapitulasi Cuti</TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad86 value=1 <?php if($ad86 == '1'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad86 value=0 <?php if($ad86 == '0'){ echo "checked=checked"; }?> size=20></TD>
                            <TD style="text-align:center;"><INPUT TYPE=radio NAME=ad86 value=2 <?php if($ad86 == '2'){ echo "checked=checked"; }?> size=20></TD>
                          </TR>
                             </table>
                    </div>
